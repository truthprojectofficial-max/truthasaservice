...
**Source File**: `GM_0350_Thu, 16 Ap_Bailey_Property_Weekly_Update.txt`
**Generated**: 2026-07-20T13:06:26.946675+00:00
**Extracted Characters**: 181724
...
| Metric | Value |
|--------|-------|
| Shannon Entropy | 4.670 bits/char |
| Normalized Entropy | 0.764 |
| Anomaly Flag | YES |
| Low Entropy Flag | No |
...
### Forensic Reasoning
- Shannon Entropy (4.670 bits/char) exceeds anomaly threshold (4.5). Possible non-human origin.
...
| GRACE Normalized Penalty | 0.0016 |
| FRUIT Composite Value Score | 0.788555 |
...
|------------|-------|
| Raw Penalty | 0.0016 |
| Normalized Penalty | 0.0016 |
| Risk Level | **LOW** |

| FRUIT Score | Value |
|-------------|-------|
| Composite Value Score | 0.788555 |
| CVS Threshold | 0.0005 |
| Compliant | **NO** |
...
**Timestamp**: 2026-07-20T13:06:26.725900+00:00
...
- **Timestamp**: 2026-07-20T13:06:26.946675+00:00
