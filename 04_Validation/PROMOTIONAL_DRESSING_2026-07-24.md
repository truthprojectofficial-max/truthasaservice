...
## PART 1: WHAT WE DO — in layman's terms
...
> patterns of deception — things like vague promises, fake
...
>
> Order Get It Right reads that email — or that contract, or that
> invoice, or that product listing — and tells you exactly what
...
> explanation and it gets recorded alongside the findings — it
> doesn't change the verdict, it adds your context.
>
> Every audit is sealed to a Merkle chain — a digital ledger that
...
> chain yourself. You don't have to trust me — you trust the math."

### What we do (bullet points for the website)

- **Read documents and flag deception patterns** — 55 patterns,
  each one explained in plain English
- **Score the likelihood of deception** — 0% to 100%, with the
  reasoning shown
- **Generate court-ready affidavits** — under Australian Consumer
  Law Section 56 + Evidence Act 1995
- **Seal everything to a tamper-proof chain** — SHA-256 Merkle
  chain, 40,000+ blocks, verifiable by anyone
- **Let the client explain** — if something flagged but there's
  truth behind it, the client submits their explanation, sealed
  to the chain as their statement
- **Work fully offline** — zero network calls in the audit engine,
  no cloud AI, no data leaving your machine

### What we DON'T do (honesty builds trust)

- We DON'T give legal advice — we're a tool, not a lawyer
- We DON'T guarantee truth or falsehood — we flag patterns, you decide
- We DON'T replace a lawyer — we give your lawyer better evidence
...
### The "back and sides" — what needs trimming
...
| **Landing page** | `docs/index.html` written (dark theme, stats, pipeline) | Enable GitHub Pages → Settings → Pages → /docs → ordergetitright.com |
...
| **GitHub profile** | `truthprojectofficial-max` | Add bio: "Truth as a Service. Building OGIR — a forensic lie-detector for business documents." Add link to ordergetitright.com |
...
| **Email signature** | None | Add: "Justin Barnett | Order Get It Right — Truth as a Service | ordergetitright.com" |
...
4. **Terms of Service** on the website (needs writing — see
...
6. **Community boards** (you mentioned placing on community boards):
   ...
   - Whirlpool (AU forum): https://whirlpool.net.au — post in the
     "What's your side project?" or "Small business" threads
   - Product Hunt: https://producthunt.com — launch when v0.1.0 is
     signed and downloadable
   - Hacker News: https://news.ycombinator.com — "Show HN: OGIR,
...
| Surface | Message |
|---------|---------|
| Landing page | "Truth as a Service. Forensic deception-detection for business documents." |
...
| Business card | "Order Get It Right — ordergetitright.com" |
| Email sig | "Justin Barnett | Order Get It Right — Truth as a Service" |

---

## PART 3: WHAT TO DO (in order)

1. [ ] Enable GitHub Pages (repo Settings → Pages → /docs → ordergetitright.com)
...
10. [ ] Post on community boards (Whirlpool, Reddit, local SA) — only AFTER the repo is public + the landing page is live + v0.1.0 is downloadable
