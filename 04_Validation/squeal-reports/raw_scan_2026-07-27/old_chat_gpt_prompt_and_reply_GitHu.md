...
**Source File**: `old_chat_gpt_prompt_and_reply_GitHu.txt`
**Generated**: 2026-07-27T14:03:25.494544+00:00
**Extracted Characters**: 10031
...
| Metric | Value |
|--------|-------|
| Shannon Entropy | 4.567 bits/char |
| Normalized Entropy | 0.729 |
| Anomaly Flag | YES |
| Low Entropy Flag | No |
...
| DD-056 | Menu-Gate Control | MEDIUM | 80.0% | do you want me to, option a |

### Forensic Reasoning
- Shannon Entropy (4.567 bits/char) exceeds anomaly threshold (4.5). Possible non-human origin.
...
**71.0%** -- Structural Deception Flag: **TRUE**
...
**Timestamp**: 2026-07-27T14:03:25.484254+00:00
...
- **Timestamp**: 2026-07-27T14:03:25.494544+00:00
