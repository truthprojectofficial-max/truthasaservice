...
def test_system_status():
    ...
    assert "67 patterns" in body["ontologyVersion"], body["ontologyVersion"]
...
def test_seed_facts_use_live_ontology_version():
    ...
    # As of v3.11, that string is "67 patterns".
    assert "67 patterns" in blob, f"seed fact missing live version: {blob!r}"
