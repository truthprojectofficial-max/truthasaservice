...
def test_system_status():
    ...
    assert "55 patterns" in body["ontologyVersion"], body["ontologyVersion"]
...
def test_seed_facts_use_live_ontology_version():
    ...
    # As of v3.10, that string is "55 patterns".
    assert "55 patterns" in blob, f"seed fact missing live version: {blob!r}"
